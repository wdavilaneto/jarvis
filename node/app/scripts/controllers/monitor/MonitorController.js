...
angular.module('jarvisApp').controller('HealthController', function ($scope, HealthCheckService) {
...
angular.module('jarvisApp').controller('MetricsController', function ($scope, MetricsService, HealthCheckService, ThreadDumpService) {
    $scope.metrics = {};
