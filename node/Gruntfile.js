...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
        ...
        options: {
          ...
          middleware: function (connect) {
            return [
              ...
              connect.static('.tmp'),
              connect().use('/client/dev/bower_components', connect.static('./client/dev/bower_components')),
    ...
    filerev: {
      dist: {
        src: [
          ...
          '<%= yeoman.dist %>/css/{,*/}*.css',
          '<%= yeoman.dist %>/imagens/{,*/}*.{png,jpg,jpeg,gif,webp,svg}',
    ...
    usemin: {
      ...
      options: {
        assetsDirs: ['<%= yeoman.dist %>','<%= yeoman.dist %>/imagens']
      }
    },
    ...
    copy: {
      dist: {
        files: [{
          ...
          expand: true,
          cwd: 'client/dev/bower_components/bootstrap/dist',
          src: 'fonts/*',
          dest: '<%= yeoman.dist %>'
        }, {
          expand: true,
          cwd: 'client/dev/bower_components/fontawesome',
          src: 'fonts/*',
          dest: '<%= yeoman.dist %>'
        }]
      },
